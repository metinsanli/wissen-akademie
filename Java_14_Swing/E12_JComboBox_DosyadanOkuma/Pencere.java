package E12_JComboBox_DosyadanOkuma;
...
public class Pencere extends JFrame {
	...
	public class ComBoxListele implements ActionListener {
		...
		public void actionPerformed(ActionEvent e) {
			...
			try {
				BufferedReader bufDosya = new BufferedReader(new InputStreamReader(new FileInputStream(new File("./src/E12_JComboBox_DosyadanOkuma/isimler.txt")), "Cp1254"));
