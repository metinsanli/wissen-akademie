...
public class PanelDaireGuncelle extends javax.swing.JPanel {
    ...
    public PanelDaireGuncelle () {
        initComponents();
        DBConn daireBilgiler = new DBConn();
        cmbDaireNo.setModel(comboBoxDoldur(daireBilgiler)); // COMBOBOX IN ICINI DOLDURUYOR
    ...
    private void cmbDaireNoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmbDaireNoActionPerformed
         ...
         */
        Daire daire = new DBConn().getDaire((String) cmbDaireNo.getSelectedItem());
