public class SuperLig2 {
	...
	public static void main(String[] args) {
		...
		String[] kulupBilgileri = { "Galatasaray", "Besiktas", "Trabzon", "Fenerbahce", "Eskisehirspor", "Sivas", "Kasimpasa", "Karabuk", "Akhisar", "Gaziantep", "Genclerbirligi", "Bursa", "Konya", "Antalya", "Rize", "Elazig", "Erciyes", "Kayseri" };
		...
		int toplam2 = 0;
		for (int i = 0; i < ligSira.length; i++) {
			System.out.printf("\n%-5d%-15s%-7d%-7d%-7d%-5d", i + 1, kulup[ligSira[i]].kulupAdi, kulup[ligSira[i]].atGol, kulup[ligSira[i]].yedGol, kulup[ligSira[i]].atGol - kulup[ligSira[i]].yedGol, kulup[ligSira[i]].puan);
